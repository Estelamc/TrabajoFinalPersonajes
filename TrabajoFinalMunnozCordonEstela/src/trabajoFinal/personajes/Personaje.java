...
public class Personaje implements Serializable, Comparable<Personaje> {
	 ...
	 * 
	 */
	private static Pattern patronNombre = Pattern.compile("^[A-Z¡…Õ”⁄—]([a-z·ÈÌÛ˙Ò]+[-][A-Z¡…Õ”⁄—])?[a-z·ÈÌÛ˙Ò]{2,}$");
	
	/**
	 * Patr&oacute;n para comparar el apellido y saber si es v&aacute;lido.
	 * A diferencia con el nombre, no se permiten guiones.
	 */
	private static Pattern patronApellido = Pattern.compile("^[A-Z¡…Õ”⁄—][a-zÒ·ÈÌÛ˙]{2,}$");
	 ...
	 * @param region Regi&oacute;n donde vive el personaje.
	 */
	protected void setRegion(Region region) { // SE CONTROLA EN CONSTRUCTOR, NO AQUÕ
		this.region = region;
	}
	 ...
	 */
	protected void setSexo(Sexo sexo) { // SE CONTROLA EN CONSTRUCTOR, NO AQUÕ
		this.sexo = sexo;
	}
	...
	// Si quisiÈramos ordenar personajes por la edad, por ejemplo, se usarÌa Comparator
	}
}
