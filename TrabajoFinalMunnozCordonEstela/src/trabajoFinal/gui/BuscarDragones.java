...
/**
 * Muestra todos los dragones del listado.
 * 
...
public class BuscarDragones extends VentanaPadre {
	 ...
	 */
	private static final long serialVersionUID = -1329607325809237462L;
	...
	/**
	 * Listado de personajes de tipo drag&oacute;n.
	 */
	private ListadoPersonajes dragones = new ListadoPersonajes();
	...
	private void recorrerListado(int posicion){
		mostrar(dragones.getPersonajePorPosicion(posicion));
	 ...
	 */
	private void buscarDragones() {
		dragones.setListado(General.personajes.getDragones());
		mostrar(dragones.getPersonajePorPosicion(indice));
		comprobarBotones();
